        ...
        <Modal show={showModal} onHide={handleCloseModal} className="modal-lg">
                ...
                <Form>
                    ...
                    <div className="mb-3">
                        ...
                        <input value={dataModal.email} name="email" onChange={handleChange} type="text" id="email" className="form-control input-lg"/>
                    </div>
                    <div className="mb-3">
                        <label htmlFor="fotourl" className="form-label">fotourl</label>
                        <input value={dataModal.fotourl} name="fotourl" onChange={handleChange} type="text" id="fotourl" className="form-control input-lg"/>
                    </div>
                    </Modal.Body>
                    <Modal.Footer>
